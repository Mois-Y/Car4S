...
public class NotifyAdapter extends RecyclerView.Adapter<NotifyAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        //设置内容布局的宽为屏幕宽度
        holder.layout_content.getLayoutParams().width = NotifyUtils.getScreenWidth(lContext);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup arg0, int arg1) {
        //获取列表中，每行的布局文件
        View view = LayoutInflater.from(lContext).inflate(R.layout.notify_layout_item, arg0, false);
